...
public class AnnotationScanner {
    ...
    private static final String COUPON_PKG="com.lin.coupon";
    ...
    /**
     * <h2>构造Controller 的权限信息</h2>
     * @param mapInfo {@link RequestMappingInfo} @RequestMapping对应的信息
     * @param handlerMethod {@link HandlerMethod} @RequestMapping对应方法的详情，包括方法，类，参数
     *
     * @return
     */
    private List<PermissionInfo> buildPermission(
        ...
        if (null==couponPermission){
            //如果没有CouponPermission且没有IgnorePermission，在日志中记录
